...
class Payment(Base):
    ...
    def __repr__(self):
        return (f"<Payment(id={self.uuid}, user_id={self.user_id}, ticket_type='{self.ticket_type}', "
...
class QRCode(Base):
    ...
    user_id = Column(String(36), ForeignKey('users.uuid'), nullable=False)  # Link to the User
    ...
    # __repr__ for debugging and logging
    def __repr__(self):
        return (f"<QRCode(uuid={self.uuid}, user_id={self.user_id}, payment_uuid={self.payment_uuid}, "
...
class SMS(Base):
    ...
    # __repr__ for debugging and logging
    def __repr__(self):
        return (f"<SMS(uuid={self.uuid}, user_id={self.user_id}, payment_uuid={self.payment_uuid}, "
